...
if (isset($_POST['installdb'])) {
    $arr = array(
        'intro_title' => 'Welcome to GneeX Latte', 'intro_text' => 'A modern magazine theme.',
        'intro_image' => '', 'background_header' => '', 'background_featured' => '',
        'background_color_header' => '#0f172a', 'background_color_footer' => '#0f172a',
        'background_color_featured' => '#1e293b', 'background_footer' => '',
        'font_color_header' => '#ffffff', 'font_color_footer' => '#94a3b8',
        'link_color_footer' => '#3b82f6',
        'link_color' => '#3b82f6', 'link_color_hover' => '#2563eb',
        'body_background_color' => '#f8fafc',
        'content_background_color_body' => '#ffffff',
        'content_border_width' => '1', 'content_border_color' => '#e2e8f0',
        'content_title_color' => '#0f172a', 'content_title_color_hover' => '#3b82f6',
        'content_title_size' => '32', 'list_title_size' => '20', 'list_title_color' => '#0f172a',
        'content_title_cat_size' => '24',
        'content_font_color_body' => '#334155',
        'sidebar_background_color_header' => '#f8fafc', 'sidebar_font_color_header' => '#1e293b',
        'sidebar_background_color_body' => '#ffffff', 'sidebar_font_color_body' => '#334155',
        'sidebar_border_width' => '1', 'sidebar_border_color' => '#e2e8f0',
        'front_layout' => 'magazine', 'category_layout' => 'magazine', 'fullwidth_page' => '',
        'featured_posts' => '',
        'panel_1' => '', 'panel_1_color' => '#3b82f6', 'panel_1_font_color' => '#ffffff',
        'panel_1_bg' => '', 'panel_1_text_color' => '', 'panel_1_font_family' => 'inherit', 'panel_1_font_size' => '1',
        'panel_2' => '', 'panel_2_color' => '#10b981', 'panel_2_font_color' => '#ffffff',
        'panel_2_bg' => '', 'panel_2_text_color' => '', 'panel_2_font_family' => 'inherit', 'panel_2_font_size' => '1',
        'panel_3' => '', 'panel_3_color' => '#f59e0b', 'panel_3_font_color' => '#ffffff',
        'panel_3_bg' => '', 'panel_3_text_color' => '', 'panel_3_font_family' => 'inherit', 'panel_3_font_size' => '1',
        'panel_4' => '', 'panel_4_color' => '#ef4444', 'panel_4_font_color' => '#ffffff',
        'panel_4_bg' => '', 'panel_4_text_color' => '', 'panel_4_font_family' => 'inherit', 'panel_4_font_size' => '1',
        'panel_5' => '', 'panel_5_color' => '#6366f1', 'panel_5_font_color' => '#ffffff',
        'panel_5_bg' => '', 'panel_5_text_color' => '', 'panel_5_font_family' => 'inherit', 'panel_5_font_size' => '1',
        'social_fb' => '#', 'social_tw' => '#', 'social_ig' => '#', 'social_yt' => '#',
        'show_breadcrumb' => 'yes', 'logo_width' => '', 'logo_height' => '50px', 'custom_css' => '',
        'container_width' => '1280', 'adsense' => '', 'analytics' => '',
        // Typography — Global
        'typo_body_font'           => '"Inter", sans-serif',
        'typo_body_size'           => '16', 'typo_body_weight' => '400', 'typo_body_color' => '#334155',
        'typo_h1_font'             => 'inherit',
        'typo_h1_size'             => '36', 'typo_h1_weight' => '800', 'typo_h1_color' => '#0f172a',
        'typo_h2_font'             => 'inherit',
        'typo_h2_size'             => '28', 'typo_h2_weight' => '700', 'typo_h2_color' => '#1e293b',
        'typo_h3_font'             => 'inherit',
        'typo_h3_size'             => '22', 'typo_h3_weight' => '700', 'typo_h3_color' => '#1e293b',
        'typo_h4_font'             => 'inherit',
        'typo_h4_size'             => '18', 'typo_h4_weight' => '600', 'typo_h4_color' => '#1e293b',
        'typo_nav_font'            => 'inherit',
        'typo_nav_size'            => '14', 'typo_nav_weight' => '600', 'typo_nav_color' => '#ffffff',
        'typo_post_title_font'     => 'inherit',
        'typo_post_title_size'     => '20', 'typo_post_title_weight' => '700', 'typo_post_title_color' => '#0f172a',
        'typo_meta_font'           => 'inherit',
        'typo_meta_size'           => '13', 'typo_meta_weight' => '400', 'typo_meta_color' => '#64748b',
        // Typography — Blog Post
        'typo_single_title_font'   => 'inherit',
        'typo_single_title_size'   => '36', 'typo_single_title_weight' => '800', 'typo_single_title_color' => '#ffffff',
        'typo_content_font'        => 'inherit',
        'typo_content_size'        => '17', 'typo_content_weight' => '400', 'typo_content_color' => '#334155',
        'typo_post_meta_font'      => 'inherit',
        'typo_post_meta_size'      => '14', 'typo_post_meta_weight' => '400', 'typo_post_meta_color' => '#64748b',
        // Typography — Extra elements
        'typo_blockquote_font'     => 'inherit',
        'typo_blockquote_size'     => '18', 'typo_blockquote_weight' => '400', 'typo_blockquote_color' => '#475569',
        'typo_breadcrumb_font'     => 'inherit',
        'typo_breadcrumb_size'     => '13', 'typo_breadcrumb_weight' => '600', 'typo_breadcrumb_color' => '#ffffff',
        'typo_comment_title_font'  => 'inherit',
        'typo_comment_title_size'  => '22', 'typo_comment_title_weight' => '700', 'typo_comment_title_color' => '#0f172a',
        'typo_comment_body_font'   => 'inherit',
        'typo_comment_body_size'   => '15', 'typo_comment_body_weight' => '400', 'typo_comment_body_color' => '#334155',
    );
        ...
        [
            ...
            'cards'    => [
                ...
                [
                    ...
                    'cols'   => 2,
                    'fields' => [
                        ['type'=>'toggle', 'name'=>'show_breadcrumb', 'label'=>'Show Breadcrumbs',
                         'yes'=>'Yes, show breadcrumbs', 'no'=>'No, hide them'],
                        ['type'=>'range',  'name'=>'container_width', 'label'=>'Container Width (px)',
                         'min'=>1000, 'max'=>1600, 'step'=>10, 'unit'=>'px', 'id'=>'container_width_val'],
                    ],
                ],
            ],
        ],
            ...
            'cards'    => [
                [
                    ...
                    'fields' => [
                        ...
                        ['type'=>'text',     'name'=>'intro_image', 'label'=>'Featured Image or YouTube URL',
        ...
        [
            ...
            'cards'    => [
                [
                    ...
                    'cols'   => 2,
                    'fields' => [
                        ['type'=>'select', 'name'=>'front_layout', 'label'=>'Homepage Layout', 'id'=>'frontpageSelector',
                         'options'=>['blog'=>'📰 Blog List','magazine'=>'🗞️ Magazine Grid','fullwidth'=>'📄 Full Width Page']],
                        ['type'=>'select', 'name'=>'category_layout', 'label'=>'Category / Archive Style',
                         'options'=>['blog'=>'Blog List','magazine'=>'Magazine Grid']],
                        ['type'=>'raw', 'html'=>'<div id="fullwidth-opt" class="gx-field" style="display:none;grid-column:1/-1;">
                ...
                [
                    ...
                    'cols'   => 2,
                    'fields' => [
                        ['type'=>'text',  'name'=>'featured_posts',           'label'=>'Featured Post IDs',
                         'placeholder'=>'e.g. 12, 15, 20', 'hint'=>'Comma-separated post IDs. These appear in the top slider above content.'],
            ...
            'cards'    => [
                [
                    ...
                    'fields' => [
                        ...
                        ['type'=>'range',  'name'=>'content_title_size',        'label'=>'Post Title Size (single page)',
                         'min'=>20, 'max'=>56, 'step'=>1, 'unit'=>'px', 'id'=>'ct_size_val'],
                        ['type'=>'range',  'name'=>'list_title_size',           'label'=>'List / Archive Title Size',
                         'min'=>16, 'max'=>44, 'step'=>1, 'unit'=>'px', 'id'=>'lt_size_val'],
                        ['type'=>'color',  'name'=>'list_title_color',          'label'=>'Index / List Title Color'],
                        ['type'=>'range',  'name'=>'content_title_cat_size',    'label'=>'Category Title Size',
                         'min'=>14, 'max'=>40, 'step'=>1, 'unit'=>'px', 'id'=>'cat_size_val', 'default'=>24],
                    ],
                ],
                [
                    'title'  => 'Body Text',
                    'fields' => [
                        ['type'=>'color', 'name'=>'content_font_color_body', 'label'=>'Body Text Color',
