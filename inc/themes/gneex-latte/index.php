        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                {foreach $feat as $id}
                    ...
                    {if !isset($p['error'])}
                        {var $p = $p[0]}
                        {var $p_img = Gneex::getImage($p->content)}
                        {var $im_url = $p_img ? Url::thumb($p_img, 'large', 500) : Url::thumb('assets/images/noimage.png', 'large')}
                            ...
                            <div class="card-body panel-body">
                                <div class="row">
                                    {if !isset($cat1_posts['error'])}
                                        ...
                                        {var $first_img = Gneex::getImage($first->content)}
                                        <div class="col-sm-5">
