<article class="blog-post blog-post-card p-0 overflow-hidden shadow-sm bg-white rounded-4 border-0 mb-4 h-100 d-flex flex-column" data-aos="fade-up">
    ...
    {var $im_url = ($p_img != "") ? Url::thumb($p_img, 'large', '800') : Url::thumb(Url::theme() . 'images/noimage.png', 'large', '800')}
    ...
    {else}
        <div class="post-img overflow-hidden bg-light d-flex align-items-center justify-content-center" style="height: 250px;">
             <img src="{Url::thumb(Url::theme() . 'images/noimage.png', 'large', '800')}" class="img-fluid opacity-25" style="width: 120px;">
        </div>
    {/if}
