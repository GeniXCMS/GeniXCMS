                    ...
                    if (isset($alertDanger)) {
                        ...
                        if ($post_id != '') {
                            foreach ($post_id as $id) {
                                ...
                                $id = Typo::int($id);
                                Posts::publish($id);
                                $data['alertSuccess'][] = _("Page {$title} Published");
                            }
                        }
                    }
                    ...
                    if (isset($alertDanger)) {
                        ...
                        if ($post_id != '') {
                            foreach ($post_id as $id) {
                                ...
                                $id = Typo::int($id);
                                Posts::unpublish($id);
                                $data['alertSuccess'][] = _("Page {$title} Unpublished");
                            }
                        }
                    }
                    if (isset($_POST['token'])) {
                    ...
                    if (isset($alertDanger)) {
                        ...
                        if ($post_id != '') {
                            foreach ($post_id as $id) {
                                ...
                                $data['alertSuccess'][] = _("Page {$title} Deleted");
                            }
                        }
                    }
                    if (isset($_POST['token'])) {
