...
class Pinger
{
    ...
    static $myBlogName          = Options::get('sitename');
    static $myBlogUrl           = Options::get('siteurl');
    static $myBlogUpdateUrl     = Options::get('siteurl');
    static $myBlogRSSFeedUrl    = Url::sitemap();
