...
$schema = [
    ...
    'content' => [
        ...
        [
            ...
            'no_padding' => true,
            'header_action' => '
                <form action="index.php?page=pages" method="get" class="d-flex gap-2">
                    ...
                    <div class="input-group input-group-sm w-auto shadow-sm rounded-pill overflow-hidden border">
                        ...
                        <input type="text" name="q" class="form-control border-0 ps-1 bg-white" placeholder="'._("Locate page...").'" style="width:180px;" value="'.($_GET['q'] ?? '').'">
                    </div>
                    <button type="submit" class="btn btn-dark btn-sm rounded-pill px-3 fw-bold shadow-sm"><i class="bi bi-filter-right me-1"></i> '._("Filter").'</button>
