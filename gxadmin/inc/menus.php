...
if (isset($data['menus']) && $data['menus'] != '') {
    ...
    foreach ($menus as $k => $m) {
        ...
        <ul class="nav nav-pills custom-pills mb-4" id="<?=$k;?>-tab">
            <li class="nav-item"><a class="nav-link active rounded-pill px-4 me-2 bg-white border text-secondary" data-bs-toggle="pill" href="#<?=$k;?>-menuitem"><?=_("Structure");?></a></li>
            <li class="nav-item"><a class="nav-link rounded-pill px-4 bg-white border text-secondary" data-bs-toggle="pill" href="#<?=$k;?>-additem"><?=_("Add Link");?></a></li>
        </ul>
...
<style>
    .custom-pills .nav-link.active { background-color: var(--gx-primary) !important; color: #fff !important; border-color: var(--gx-primary) !important; box-shadow: 0 4px 10px rgba(13, 110, 253, 0.2); }
