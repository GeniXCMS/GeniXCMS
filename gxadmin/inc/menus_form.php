    ...
    <div class="row g-4">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="text" name='class' class="form-control border-0 bg-light rounded-3 py-2 px-3" placeholder="nav-item">
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="mb-4">
                ...
                <input type="text" name='name' class="form-control border-0 bg-light rounded-4 py-3 px-4 fw-bold fs-5" placeholder="<?=_("Friendly Name...");?>" required>
                <div class="extra-small text-muted mt-1 ps-2"><?=_("This text will be displayed to your visitors.");?></div>
            </div>
        </div>
        ...
        <div class="col-12 mt-2">
            ...
            <div class="row g-3">
                    ...
                    <div class="card border-0 bg-light rounded-4 p-3 h-100">
                        <div class="form-check d-flex align-items-start gap-2">
                            ...
                            <label class="form-check-label flex-grow-1" for="typePage">
                                ...
                                <div class="extra-small text-muted mb-2"><?=_("Connect to an existing static page.");?></div>
                                <?php
                                $vars = array(
                                    'name' => 'page',
                                    'type' => 'page',
                    ...
                    <div class="card border-0 bg-light rounded-4 p-3 h-100">
                        <div class="form-check d-flex align-items-start gap-2">
                            ...
                            <label class="form-check-label flex-grow-1" for="typeCat">
                                ...
                                <div class="extra-small text-muted mb-2"><?=_("Link to a specific category archive.");?></div>
                                <?php
                                $vars = array(
                                    'name' => 'cat',
                                    'sort' => 'ASC',
                    ...
                    <div class="card border-0 bg-light rounded-4 p-3 h-100">
                        <div class="form-check d-flex align-items-start gap-2">
                            ...
                            <label class="form-check-label flex-grow-1" for="typeMod">
                                ...
                                <div class="extra-small text-muted mb-2"><?=_("Direct access to installed modular features.");?></div>
                ...
                <div class="col-md-6">
                    <div class="card border-0 bg-light rounded-4 p-3 h-100">
                        <div class="form-check d-flex align-items-start gap-2">
                            <input type="radio" name='type' id="typeCustom" class="form-check-input mt-1" value="custom">
                            <label class="form-check-label flex-grow-1" for="typeCustom">
                                <div class="fw-bold text-dark small"><?=_("Custom Endpoint");?></div>
                                <div class="extra-small text-muted mb-2"><?=_("Link to an external site or custom URL.");?></div>
                                <input class="form-control form-control-sm border-0 bg-white rounded-pill px-3 mt-1" name="custom" placeholder="https://...">
                            </label>
                        </div>
                    </div>
                </div>
