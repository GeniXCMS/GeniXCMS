...
$schema = [
    ...
    'content' => [
        ...
        [
            ...
            'no_padding' => true,
            'header_action' => '
                <form action="index.php?page=users" method="get" class="d-flex gap-2">
                    <input type="hidden" name="page" value="users">
                    <input type="hidden" name="token" value="'.TOKEN.'">
                    <input type="text" name="q" class="form-control form-control-sm rounded-pill px-3 shadow-none border bg-light" placeholder="'._("Account...").'" style="width:200px;">
...
<style>
    .flag-icon { width: 22px; height: 16px; display: inline-block; background-size: contain; background-position: center; background-repeat: no-repeat; }
</style>
