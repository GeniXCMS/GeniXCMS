...
$schema = [
    ...
    'tabs' => [
        'general' => [
            'label' => _('General'), 'icon' => 'bi bi-grid-1x2',
            'content' => [
        ...
        'localization' => [
            'label' => _('Localization'), 'icon' => 'bi bi-translate',
            'content' => [
        ...
        'email' => [
            'label' => _('Transmission'), 'icon' => 'bi bi-send-check',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ...
                    ['width' => 7, 'content' => [
                        ['type' => 'card', 'title' => _('SMTP Relay Credentials'), 'icon' => 'bi bi-key', 'body_elements' => [
        ...
        'social' => [
            'label' => _('Social'), 'icon' => 'bi bi-share',
            'content' => [
        ...
        'identity' => [
            'label' => _('Identity'), 'icon' => 'bi bi-gem',
            'content' => [
        ...
        'assets' => [
            'label' => _('Assets'), 'icon' => 'bi bi-boxes',
            'content' => [
                ...
                ['type' => 'card', 'title' => _('Modern Build Pipeline (Vite)'), 'icon' => 'bi bi-lightning', 'body_elements' => [
        ...
        'posts' => [
            'label' => _('Registry'), 'icon' => 'bi bi-journal-check',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ['width' => 6, 'content' => [
                        ['type' => 'card', 'title' => _('Authoring Pipeline'), 'icon' => 'bi bi-brush', 'body_elements' => [
                            ...
                            ['type' => 'select', 'label' => _('Architect Preferred Engine'), 'name' => 'editor_type', 'selected' => Options::v('editor_type'), 'options' => ['summernote' => 'Summernote Classic', 'editorjs' => 'Editor.js (Blocks)', 'ckeditor' => 'CKEditor Industry']]
                    ...
                    ['width' => 6, 'content' => [
                        ['type' => 'card', 'title' => _('Discovery Pinger'), 'icon' => 'bi bi-broadcast', 'body_elements' => [
        ...
        'payment' => [
            'label' => _('Payment'), 'icon' => 'bi bi-credit-card-2-front',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ...
                    ['width' => 8, 'content' => [
                        ['type' => 'card', 'title' => _('PayPal Provider'), 'icon' => 'bi bi-paypal', 'body_elements' => [
        ...
        'security' => [
            'label' => _('Security'), 'icon' => 'bi bi-shield-lock',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ['width' => 7, 'content' => [
                        ['type' => 'card', 'title' => _('Bot Barrier (reCAPTCHA)'), 'icon' => 'bi bi-robot', 'body_elements' => [
                    ...
                    ['width' => 5, 'content' => [
                        ['type' => 'card', 'title' => _('RESTful API KEY'), 'icon' => 'bi bi-file-earmark-lock', 'body_elements' => [
                            ['type' => 'raw', 'html' => '
