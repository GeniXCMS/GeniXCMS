...
foreach ($data['permissions'] as $key => $p) {
    $row = [
        ['content' => "
            ...
            <div class='extra-small text-muted font-monospace opacity-75'>{$key}</div>", 'class' => 'ps-4 py-3']
    ];
...
<style>
    .permission-switch { cursor: pointer; width: 2.5em !important; height: 1.25em !important; }
    .permission-switch:checked { background-color: #3b82f6 !important; border-color: #3b82f6 !important; }
    .permission-switch:focus { box-shadow: 0 0 0 0.25rem rgba(59, 130, 246, 0.25) !important; }
</style>
