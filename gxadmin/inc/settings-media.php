...
$schema = [
    ...
    'tabs' => [
        'storage' => [
            'label' => _('Storage Location'), 'icon' => 'bi bi-folder-check',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ...
                    ['width' => 6, 'content' => [
                        ['type' => 'alert', 'style' => 'warning', 'content' => '
        ...
        'processing' => [
            'label' => _('Optimization'), 'icon' => 'bi bi-lightning',
            'content' => [
        ...
        'watermark' => [
            'label' => _('Watermark'), 'icon' => 'bi bi-patch-check',
            'content' => [
                ...
                ['type' => 'row', 'items' => [
                    ...
                    ['width' => 6, 'content' => [
                        ['type' => 'card', 'title' => _('Watermark Position'), 'body_elements' => [
                            ['type' => 'select', 'name' => 'media_watermark_pos', 'selected' => (Options::v('media_watermark_pos') ?: 'center'), 'options' => [
