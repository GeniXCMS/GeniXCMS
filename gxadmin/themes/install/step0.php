    ...
    <div class="row g-4 mb-5">
        <div class="col-md-12">
            ...
            <div class="input-group">
                <span class="input-group-text bg-light border-end-0"><i class="fa-solid fa-server text-muted"></i></span>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                <span class="input-group-text bg-light border-end-0"><i class="fa-solid fa-database text-muted"></i></span>
                <input type="text" name="dbname" class="form-control border-start-0 ps-0" placeholder="e.g. genix_db" required>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                <span class="input-group-text bg-light border-end-0"><i class="fa-solid fa-cloud-bolt text-muted"></i></span>
                <input type="text" name="dbhost" class="form-control border-start-0 ps-0" value="localhost" placeholder="e.g. localhost" required>
            </div>
            <div class="form-text small opacity-75">Commonly <kbd class="py-0 px-1 bg-light text-muted border">localhost</kbd> or IP address.</div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" name="dbuser" class="form-control border-start-0 ps-0" placeholder="e.g. root" required>
            </div>
