    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" name="sitedomain" class="form-control border-start-0 ps-0" value="<?= $_SERVER['HTTP_HOST']; ?>" required>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" name="siteurl" class="form-control border-start-0 ps-0" value="http://<?= $_SERVER['HTTP_HOST']; ?>/" required>
            </div>
