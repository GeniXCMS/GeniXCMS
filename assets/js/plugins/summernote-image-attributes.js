    ...
    $.extend(true,$.summernote.lang,{
        ...
        'id-ID':{
            imageAttributes:{
                ...
                alt:'Alt',
                class:'Class',
                classSelect:'Pilih Class',
                style:'Style',
                href:'URL',
                target:'Tujuan',
                linkClass:'Tautan Class',
                rel:'Tautan Rel',
                relBlank:'Jangan pakai atribut Rel',
                relAlternate:'Alternatif: Tautan ke dokumen alternatif',
                relAuthor:'Penulis: Tautan ke penulis dokumen.',
                relBookmark:'Bookmark: URL permanen untuk bookmark',
                relHelp:'Bantuan: Tautan ke dokumen bantuan',
                relLicense:'Lisensi: Tautan ke lisensi dokumen',
                relNext:'Berikut: Dokumen berikutnya',
                relNofollow:'NoFollow: Link ke dokumen unendorsed, seperti link berbayar, juga menghentikan Search Engine mengikuti tautan ini',
                relNoreferrer:'NoReferrer: Browser tidak harus mengirim Header HTTP',
                relPrefetch:'PreFetch: Specifies that the target document should be cached',
                relPrev:'Sebelum: Dokumen sebelumnya',
                relSearch:'Cari: Tautan alat pencarian',
                relTag:'Tag: Tag (kata kunci) untuk dokumen'
            }
        },
        'zh-TW':{
            imageAttributes:{
